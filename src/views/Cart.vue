      ...
      <div class="row">
        <div class="product-list-item">
          <div class="no-gutters">
            <div class="product-about" v-for="(p, index) in cart" :key="p?.id">
              <div class="product-image">
                <img
                  class="img"
                  :src="'http://38.242.229.113:8055/assets/' + p?.image?.id + '?width=190&height=200'"
                  alt
                  @click="move(p.id)"
                />
              </div>
              <div @click="move(p.id)" class="product-description">
                <div>
